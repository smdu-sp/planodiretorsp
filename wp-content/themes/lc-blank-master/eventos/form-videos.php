<div id="videos">
    <h1>Vídeos</h1>    
        <div class="row" v-for="video in novoVideo">
            <!-- Botões do Topo -->
            <div class="col-12 mt-5 mb-5" v-if="!novoVideo[0].aberto && !videoAtual.aberto && !destaque.aberto && !editarCat && ordenacaoHabilitada && !ordenacaoPendente">
                <div class="row">
                    <div class="col-auto">
            ...
            <!-- Editar Categoria -->
            <div v-if="!novoVideo[0].aberto && !videoAtual.aberto && !destaque.aberto && editarCat" class="col-12">
